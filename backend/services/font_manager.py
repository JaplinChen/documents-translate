...
def clone_font_props(
    ...
    Args:
        ...
        target_language: Optional target language code (e.g. 'vi') to apply font mapping.
    ...
    try:
        if source_font.name:
            ...
            if target_language:
                ...
                if font_mapping and lang_code in font_mapping and font_mapping[lang_code]:
        ...
        elif source_font.color and source_font.color.type != 0:  # MSO_COLOR_TYPE.NONE = 0
            try:
