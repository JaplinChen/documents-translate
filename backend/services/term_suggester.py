...
TECH_PATTERNS = [
    re.compile(r'\b(?:API|SDK|HTTP|HTTPS|JSON|XML|SQL|CSS|HTML|JS|PDF|AI|ML|UI|UX)\b', re.IGNORECASE),
...
KNOWN_PRODUCTS = {
    "notion", "obsidian", "excel", "powerpoint", "word", "google", "microsoft",
    "slack", "discord", "zoom", "github", "gitlab", "docker", "kubernetes",
    "react", "vue", "angular", "node", "python", "java", "typescript",
    "chatgpt", "gpt", "claude", "gemini", "ollama", "openai", "anthropic",
}
