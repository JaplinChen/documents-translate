...
def detect_untranslated(source: str, translated: str, source_lang: str = "vi") -> bool:
    ...
    technical_terms = {'database', 'api', 'http', 'https', 'json', 'xml', 'html', 'css', 
                      'javascript', 'python', 'react', 'vue', 'notion', 'obsidian', 'wiki',
                      'email', 'cloud', 'server', 'client', 'user', 'admin', 'login', 'logout'}
